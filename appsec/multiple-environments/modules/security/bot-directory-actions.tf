...
resource "akamai_botman_akamai_bot_category_action" "tfdemo_automated_shopping_cart_and_sniper_bots_75493431-b41a-492c-8324-f12158783ce1" {
  config_id          = akamai_appsec_configuration.config.config_id
  security_policy_id = akamai_botman_bot_management_settings.tfdemo.security_policy_id
  category_id        = "75493431-b41a-492c-8324-f12158783ce1"
  akamai_bot_category_action = jsonencode(
    {
      "action" : var.bot_automated_shopping_cart_and_sniper
    }
  )
}
