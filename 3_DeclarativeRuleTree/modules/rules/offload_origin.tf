data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_offload_origin" {
  rules_v2023_01_05 {
    name                  = "Offload origin"
    is_secure             = false
    ...
    children = [
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_css_and_java_script.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_fonts.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_images.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_files.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_other_static_objects.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_html_pages.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_redirects.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_post_responses.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_graph_ql.json,
      data.akamai_property_rules_builder.jaescalo_terraform-prod_rule_uncacheable_objects.json,
    ]
  }
}

data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_css_and_java_script" {
  rules_v2023_01_05 {
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_fonts" {
  rules_v2023_01_05 {
    name                  = "Fonts"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_images" {
  rules_v2023_01_05 {
    name                  = "Images"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_files" {
  rules_v2023_01_05 {
    name                  = "Files"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_other_static_objects" {
  rules_v2023_01_05 {
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_html_pages" {
  rules_v2023_01_05 {
    name                  = "HTML pages"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_redirects" {
  rules_v2023_01_05 {
    name                  = "Redirects"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_post_responses" {
  rules_v2023_01_05 {
    name                  = "POST responses"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_graph_ql" {
  rules_v2023_01_05 {
    name                  = "GraphQL"
    is_secure             = false
...
data "akamai_property_rules_builder" "jaescalo_terraform-prod_rule_uncacheable_objects" {
  rules_v2023_01_05 {
